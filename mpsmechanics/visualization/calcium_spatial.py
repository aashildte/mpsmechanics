...
def plot_1d_values(images, values, time, time_step, metadata):
    ...
    subtitles = ["Original image", "Pixel intensity, relative to baseline"]
...
def visualize_calcium(input_file, animate=False, overwrite=False, framerate_scale=0.2):
