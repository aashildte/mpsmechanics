...
def _calc_relevant_stats(values, intervals, tf_filter, output_folder, pref):
    ...
    values = write2read(values, output_folder, pref + "_original")
    folded = write2read(folded, output_folder, pref + "_folded")
...
def _calc_displacement(displacement, intervals, tf_filter, output_folder):
...
def _calc_displacement_minmax(displacement, intervals, tf_filter, output_folder):

    pref = "displacement_minmax"
...
def _calc_xmotion(displacement, angle, intervals, tf_filter, output_folder):
...
def _calc_ymotion(displacement, angle, intervals, tf_filter, output_folder):
...
def _calc_velocity(displacement, time, intervals, tf_filter, output_folder):
...
def _calc_prevalence(velocity_norm, intervals, tf_filter, output_folder):
...
def _calc_deformation_tensor(displacement, dx, intervals, tf_filter, output_folder):

    pref = "deformation_tensor"
...
def _calc_gl_strain_tensor(deformation_tensor, intervals, tf_filter, output_folder):

    pref = "greenlagrange_strain_tensor"
...
def _calc_principal_strain(gl_strain_tensor, intervals, tf_filter, output_folder):

    pref = "principal_strain"
...
def calc_spatial_metrics(displacement, time, dx, angle, intervals, output_folder):
    """
    ...
    displacement_d = _calc_displacement(displacement, intervals, \
                                        tf_filter_uniform, output_folder)
    ...
    xmotion_d = _calc_xmotion(displacement, angle, intervals, \
                              tf_filter_timedep, output_folder)
    ...
    def_tensor_d = _calc_deformation_tensor(displacement, dx, \
                                            intervals, tf_filter_constrd, output_folder)
    ...
    pr_strain_d = _calc_principal_strain(gl_strain_tensor_d["all_values"], intervals, \
                                         tf_filter_constrd, output_folder)
